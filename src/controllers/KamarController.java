...
public class KamarController {
    ...
    private void showFormDialog(Kamar kamar) {
        ...
        btnSimpan.addActionListener(e -> {
            try {
                if (txtNomor.getText().trim().isEmpty() || txtHarga.getText().trim().isEmpty()) {
                    JOptionPane.showMessageDialog(dialog, "Nomor Kamar dan Harga Sewa tidak boleh kosong!", "Peringatan", JOptionPane.WARNING_MESSAGE);
                    return;
                }
                ...
                String statusBaru = cbStatus.getSelectedItem().toString().toLowerCase(); // Ambil status baru
                ...
                JOptionPane.showMessageDialog(dialog, "Pastikan format Harga berupa Angka tanpa huruf (Contoh: 1500000)", "Input Tidak Valid", JOptionPane.ERROR_MESSAGE);
            }
        });
