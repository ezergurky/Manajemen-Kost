...
public class TagihanPanel extends JPanel {
    ...
    private void initComponents() {
        ...
        JLabel titleLabel = new JLabel("Tagihan Bulanan");
        titleLabel.setFont(new Font("Segoe UI", Font.BOLD, 18));
        titleLabel.setForeground(TEXT_DARK);

        JLabel subLabel = new JLabel("Kelola pembuatan invoice, pencatatan biaya tambahan, dan distribusi tagihan kost");
    ...
    private JPanel createTablePanel() {
        ...
        String[] columns = {"No. Invoice", "Nama Penghuni", "Kamar", "Total Tagihan", "Batas Waktu", "Status"};
        ...
        tableTagihan.getColumnModel().getColumn(1).setCellRenderer(paddingRenderer);
        tableTagihan.getColumnModel().getColumn(2).setCellRenderer(centerRenderer);
