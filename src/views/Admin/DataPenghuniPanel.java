...
public class DataPenghuniPanel extends JPanel {
    ...
    private void initComponents() {
        ...
        JLabel titleLabel = new JLabel("Data Penghuni");
        titleLabel.setFont(new Font("Segoe UI", Font.BOLD, 18));
        titleLabel.setForeground(TEXT_DARK);

        JLabel subLabel = new JLabel("Kelola data informasi seluruh penghuni kost secara berkala");
    ...
    private JPanel createToolbarPanel() {
        ...
        txtSearch = new JTextField("Cari nama atau nomor kamar...");
        ...
        txtSearch.addFocusListener(new FocusAdapter() {
            ...
            public void focusGained(FocusEvent e) {
                if (txtSearch.getText().equals("Cari nama atau nomor kamar...")) {
                    txtSearch.setText("");
            ...
            public void focusLost(FocusEvent e) {
                if (txtSearch.getText().trim().isEmpty()) {
                    txtSearch.setForeground(TEXT_LIGHT);
                    txtSearch.setText("Cari nama atau nomor kamar...");
                }
                txtSearch.setBorder(new CompoundBorder(
                        new LineBorder(BORDER_COLOR, 1, true),
                        new EmptyBorder(0, 12, 0, 12)
    ...
    private JPanel createTablePanel() {
        ...
        String[] columns = {"ID Penghuni", "Nama Lengkap", "Kamar", "Nomor Telepon", "Tanggal Masuk", "Status"};
        ...
        tablePenghuni = new JTable(tableModel);
        tablePenghuni.setFont(new Font("Segoe UI", Font.PLAIN, 13));
        tablePenghuni.setRowHeight(40);
        tablePenghuni.setGridColor(new Color(241, 245, 249));
        tablePenghuni.setSelectionBackground(new Color(20, 184, 166, 20));
        tablePenghuni.setSelectionForeground(TEXT_DARK);
        tablePenghuni.setShowVerticalLines(false);

        JTableHeader header = tablePenghuni.getTableHeader();
        ...
        tablePenghuni.getColumnModel().getColumn(0).setCellRenderer(centerRenderer);
        tablePenghuni.getColumnModel().getColumn(1).setCellRenderer(paddingRenderer);
        tablePenghuni.getColumnModel().getColumn(2).setCellRenderer(centerRenderer);
        tablePenghuni.getColumnModel().getColumn(3).setCellRenderer(paddingRenderer);
        tablePenghuni.getColumnModel().getColumn(4).setCellRenderer(centerRenderer);
        tablePenghuni.getColumnModel().getColumn(5).setCellRenderer(centerRenderer);

        JScrollPane scrollPane = new JScrollPane(tablePenghuni);
    ...
    public JTable getTablePenghuni() { return tablePenghuni; }
